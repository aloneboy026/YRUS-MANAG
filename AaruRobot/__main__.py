...
buttons = [
    ...
    [
        ...
        InlineKeyboardButton(
            text="🥀 ⏤͟͟『☾𝕆𝕨𝕟𝕖𝕣™☽』🥀", url="https://t.me/matna_setha"),
    ],
    [
        InlineKeyboardButton(
            text="🥀☾ꜱᴜᴘᴘᴏʀᴛ™☽🥀", url=f"https://t.me/comrade_network"
        ),
        InlineKeyboardButton(
            text="🥀☾ᴜᴘᴅᴀᴛᴇ™☽🥀", url=f"https://t.me/mondo_lover"
        ),
    ],
]

AaruRobot_IMG = "https://te.legra.ph/file/db058aa5773bd233683b2.jpg"

HELP_STRINGS = f"""
𝐈𝛕ᷟ‌𝚣⃪ꙴ ⋆‌⃝ʙᴀʙʏ𓃭 ⃟ʟᴏᴠᴇʀ⛦⃕‌༆ *ᴇxᴄʟᴜsɪᴠᴇ ꜰᴇᴀᴛᴜʀᴇs*\n*» ᴄʜᴇᴄᴋᴏᴜᴛ ᴀʟʟ ᴛʜᴇ ᴄᴏᴍᴍᴀɴᴅs*\n*» ᴀʟʟ ᴏꜰ ᴍʏ ᴄᴏᴍᴍᴀɴᴅs ᴄᴀɴ ʙᴇ ᴜsᴇᴅ ᴡɪᴛʜ / ᴏʀ !*\n*» ɪꜰ ʏᴏᴜ ɢᴏᴛ ᴀɴʏ ɪssᴜᴇ ᴏʀ ʙᴜɢ ɪɴ ᴀɴʏ ᴄᴏᴍᴍᴀɴᴅ ᴘʟᴇᴀsᴇ ʀᴇᴘᴏʀᴛ ɪᴛ ᴛᴏ @{SUPPORT_CHAT}*\n\n*ㅤㅤㅤㅤㅤㅤ» ᴍᴀɪɴ ᴄᴏᴍᴍᴀɴᴅꜱ «*\n\n➲ /start : *ꜱᴛᴀʀᴛꜱ ᴍᴇ | ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ᴍᴇ ʏᴏᴜ'ᴠᴇ ᴀʟʀᴇᴀᴅʏ ᴅᴏɴᴇ ɪᴛ​.*\n➲ /donate : *sᴜᴘᴘᴏʀᴛ ᴍᴇ ʙʏ ᴅᴏɴᴀᴛɪɴɢ ꜰᴏʀ ᴍʏ ʜᴀʀᴅᴡᴏʀᴋ​.*\n➲ /help  : *ᴀᴠᴀɪʟᴀʙʟᴇ ᴄᴏᴍᴍᴀɴᴅꜱ ꜱᴇᴄᴛɪᴏɴ.*\n*  ‣ ɪɴ ᴘᴍ : ᴡɪʟʟ ꜱᴇɴᴅ ʏᴏᴜ ʜᴇʟᴘ​ ꜰᴏʀ ᴀʟʟ ꜱᴜᴘᴘᴏʀᴛᴇᴅ ᴍᴏᴅᴜʟᴇꜱ.*\n*  ‣ ɪɴ ɢʀᴏᴜᴘ : ᴡɪʟʟ ʀᴇᴅɪʀᴇᴄᴛ ʏᴏᴜ ᴛᴏ ᴘᴍ, ᴡɪᴛʜ ᴀʟʟ ᴛʜᴀᴛ ʜᴇʟᴘ​ ᴍᴏᴅᴜʟᴇꜱ.*"""

DONATE_STRING = """[⏤͟͟͞͞x𝐃🥀| 𓆩 𝕆𝕨𝕟𝕖𝕣 𓆪 |∘𖣘︎⃞⃟🔥](https://t.me/matna_setha)"""
...
def Source_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "source_":
        query.message.edit_text(
            text="""*ʜᴇʏ,*\n\n*ᴛʜɪs ɪs 𝐈𝛕ᷟ‌𝚣⃪ꙴ ⋆‌⃝ʙᴀʙʏ𓃭 ⃟ʟᴏᴠᴇʀ⛦⃕‌༆ *\n\n*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://github.com/LEGEND-LX)\n\n*ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ ɪs ɪɴ ᴅᴇᴠᴇʟᴏᴘᴍᴇɴᴛ ᴀɴᴅ ɴᴏᴛ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ʏᴇᴛ*\n*sᴏ ɪғ ʏᴏᴜ ғᴏᴜɴᴅ ᴀɴʏ ʙᴜɢ ᴏʀ ɪғ ʏᴏᴜ ᴡᴀɴɴᴀ ʀᴇǫᴜᴇsᴛ ᴀɴʏ ғᴇᴀᴛᴜʀᴇ, ᴩʟᴇᴀsᴇ ʟᴇᴛ ᴜs ᴋɴᴏᴡ ᴀᴛ* [🦇⏤͟͟『☾𓆩ℤ𝓪𝓲𝓃𓆪ﾒ™☽ 🦇 𝐑𝐎𝐁𝐎𝐓](https://t.me/Friendly_Chat_Group) *ᴏʀ ʏᴏᴜ ᴄᴀɴ ᴄᴏɴᴛᴀᴄᴛ ᴍʏ ᴅᴇᴠᴇʟᴏᴩᴇʀ :* [⏤͟͟͞͞x𝐃🥀| 𓆩 𝕆𝕨𝕟𝕖𝕣 𓆪 |∘𖣘︎⃞⃟🔥](https://t.me/Danishzain05)""",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.send_photo(f"@{SUPPORT_CHAT}", "https://telegra.ph/file/89c32cacb49cc922f609f.jpg", caption="⏤͟͟『☾𓆩ℤ𝓪𝓲𝓃𓆪™☽』 ʀᴏʙᴏᴛ ɪs ᴀʟɪᴠᴇ !\n\nᴍᴀᴅᴇ ᴡɪᴛʜ 🖤 ʙʏ @ll_ll_LegendHacker_IN_ll_ll")
        except Unauthorized:
            LOGGER.warning(
